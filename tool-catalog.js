globalThis.DEV_TOOLS_CATALOG = Object.freeze([
  {
    ...
    description: "Convert UTF-8 text and bytes between binary, hex, decimal and octal, or convert arbitrary-size integers between any base 2–36 with two's complement views, instantly in your browser.",
    capabilities: ["UTF-8 text and byte conversion across binary, hex, decimal, and octal", "Arbitrary-precision integer conversion between bases 2–36 with prefix auto-detect", "Two's complement at 8–128 bits with overflow warnings, bit/byte length, and digit grouping"],
  },
  {
    id: "bcrypt-generator",
  ...
  },
  {
    ...
    description: "Generate cryptographically secure passwords and hashes, and analyse password strength against dictionary, l33t, keyboard, sequence, repeat and date patterns, locally in your browser.",
    capabilities: ["Cryptographically secure password generation", "MD5/SHA hash generation", "Pattern-aware password strength analysis with crack-time estimates"],
  },
  {
  ...
  },
  {
    ...
    description: "Convert JSON to XML and XML to JSON, or pretty-print, minify, and validate XML while keeping comments, CDATA, namespaces, and mixed-content spacing, locally in your browser.",
    capabilities: ["JSON-to-XML and XML-to-JSON conversion", "XML formatter: 2/4-space or tab indent, minify, sort attributes", "Validation with line and column errors"],
  },
  {
    id: "json-yaml-toml-converter",
    name: "JSON ⇄ YAML ⇄ TOML Converter",
    route: "json-yaml-toml-converter",
    description: "Convert between JSON, YAML, and TOML in any direction, or format and validate each in place — Kubernetes manifests, CI configs, Cargo and pyproject files — locally in your browser.",
  ...
  },
  {
    ...
    description: "Generate RSA, ECDSA and Ed25519 key pairs in your browser with WebCrypto. Export PKCS#8/SPKI PEM, JWK with an RFC 7638 kid, and OpenSSH public keys with SHA256 fingerprints.",
  ...
  },
  {
    ...
    name: "OTP Generator",
    route: "otp-generator",
    description: "Generate and verify TOTP and HOTP one-time codes (RFC 6238 / RFC 4226) with SHA-1, SHA-256 or SHA-512, import or build otpauth:// URIs, and scan the setup QR code.",
    capabilities: ["TOTP and HOTP codes with countdown, previous and next", "Validate a code against a ±1 step window", "otpauth:// URI import, builder and QR code"],
  },
  {
    id: "qr-generator",
    name: "QR Generator",
  ...
  },
  {
    ...
    route: "text-encryptor",
    description: "Encrypt and decrypt text with AES-256-GCM, using a password (PBKDF2-SHA-256, 600k iterations) or a raw 256-bit key, as a portable Base64 token, entirely in your browser.",
