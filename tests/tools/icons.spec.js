...
const TOOLS = [
  ...
  'json-xml-converter','json-yaml-toml-converter', 'jwt-debugger','key-pair-generator', 'markdown-editor','otp-generator', 'qr-generator',
  'regex-cheatsheet','regex-tester', 'sql-formatter', 'string-escaper', 'subnet-calculator', 'text-diff','text-encryptor','text-utilities','timestamp-converter', 'unit-converter','url-parser','user-agent-parser',
];
