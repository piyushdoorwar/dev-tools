...
const TOOLS = [
  'base-converter', 'color-converter', 'crypto-generator','encoder-decoder', 'fake-data-generator', 'file-compressor',
  ...
  'regex-tester', 'sql-formatter', 'text-diff','timestamp-converter', 'unit-converter',
];
